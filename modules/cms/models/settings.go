...
type Setting struct {
	...
	SetType     string       `json:"set_type" gorm:"type:varchar(100);default:'text'" validate:"oneof=text textarea number checkbox radio select selects file image files images richtext markdown"`
